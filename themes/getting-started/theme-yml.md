...
#### Disable `core.js` loading on custom theme

It may be needed to disable `core.js` loading and provide a custom implementation of whole logic initally contained in `core.js`.
