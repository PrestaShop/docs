...
Your PHP code should be compatible with [PHP compatibility chart]({{< relref "/9/basics/installation/system-requirements#php-compatibility-chart" >}})
...
Use our [.editorconfig](https://editorconfig.org/) file in order to easily configure your editor: https://github.com/PrestaShop/PrestaShop/blob/9.1.x/.editorconfig
...
Make sure your linter tool follows our .eslint file: https://github.com/PrestaShop/PrestaShop/blob/9.1.x/js/.eslintrc.js
