...
* `PrestaShop\PrestaShop\Adapter\Addons\AddonsDataProvider::downloadModule()`
* `PrestaShop\PrestaShop\Adapter\Addons\AddonsDataProvider::isAddonsAuthenticated()`
...
| paragonie/random_compat    |              | _Removed_      |
| prestashop/circuit-breaker | 3.0          | 4.0            |
| shudrum/array-finder       | 1.1          | _Removed_      |
