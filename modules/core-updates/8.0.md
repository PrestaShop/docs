...
* All modules present in the `modules` directory during the web-based installation process will be installed by default [unless the user chooses otherwise](https://github.com/PrestaShop/PrestaShop/pull/27099). Modules can use `Module::postInstall()` to execute code after the shop installation is done ([Read more](https://github.com/PrestaShop/PrestaShop/pull/24676)).
