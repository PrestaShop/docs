...
* `PrestaShop\PrestaShop\Adapter\Webservice\WebserviceConfiguration`
  ...
  - `__construct()` - This method [now takes two additional parameters](https://github.com/PrestaShop/PrestaShop/pull/25872), `Context $shopContext` and `FeatureInterface $multistoreFeature`.
