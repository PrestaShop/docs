...
* Historically the default Carrier's name was `0`, [now](https://github.com/PrestaShop/PrestaShop/pull/27439) it is `Click and collect`
* Live exchange rate feature [has been removed](https://github.com/PrestaShop/PrestaShop/pull/28177) from the core
* In back office, the .rtlfix file [has been removed](https://github.com/PrestaShop/PrestaShop/pull/28277). It means that if you use it, you'll need to port your changes inside the SCSS stylesheet.
* Version 8 comes with a [new Distribution API](https://github.com/PrestaShop/PrestaShop/pull/27632), and native modules are now available from the API dedicated to open source projects with a possibility to include your source of modules in the PrestaShop
* Because of the [support for PHP 8.1](https://github.com/PrestaShop/PrestaShop/pull/28402) a lot of methods have return types now
...
* A new password policy to manage password complexity [has been implemented](https://github.com/PrestaShop/PrestaShop/pull/28127). This might require third-party solutions that generate customer data to implement changes accordingly.
* In some countries, Google Fonts service has been judged incompatible with GDPR. We [changed](https://github.com/PrestaShop/PrestaShop/issues/27541) how fonts are loaded in some places of the software. This should not affect your work, but spreading awareness around this topic is essential.
...
* The theme [now supports](https://github.com/PrestaShop/classic-theme/pull/21) a new password policy introduced [here](https://github.com/PrestaShop/PrestaShop/pull/28127/)
...
System-specific files, like IDE configuration and generated ones by OS, are [no longer ignored by the repository](https://github.com/PrestaShop/PrestaShop/pull/28623). They should to be added to the [global .gitignore](https://github.com/PrestaShop/PrestaShop/pull/28623#issuecomment-1144575464).
...
* `Cart`
  - `replaceZeroByShopName()` - the parameter `$tr` [has been removed](https://github.com/PrestaShop/PrestaShop/pull/26913)
...
* `Validate::isPlaintextPassword()` → Avoid using this method. There are [new methods](https://github.com/PrestaShop/PrestaShop/pull/28127/) to check the password correctness
* `Validate::isPasswdAdmin()` → Avoid using this method. There are [new methods](https://github.com/PrestaShop/PrestaShop/pull/28127/) to check the password correctness
