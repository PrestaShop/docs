...
PrestaShop 9.1 adds support for PHP 8.5, which is now the recommended PHP version. PHP 8.1, 8.2, 8.3, and 8.4 remain supported. See the [system requirements]({{< relref "/9/basics/installation/system-requirements#php-compatibility-chart" >}}) for the full compatibility chart.
