...
{{% notice info %}} **What is a feature flag?** A feature flag is a switch that turns a specific capability on or off in your shop. Some features and migrated pages ship behind a flag so you can opt in and test them before they become the default. You will find these switches on the *New & Experimental Features* page, under the *Advanced Parameters* menu in the Back Office. {{% /notice %}}
...
| ------------- | ------------ | --------------------------------------------------------------------------------- |
| `tag`         | Stable       | Tag page migrated to Symfony. [#40238](https://github.com/PrestaShop/PrestaShop/pull/40238) |
