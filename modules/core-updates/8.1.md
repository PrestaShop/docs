...
* Introduced `PrestaShop\PrestaShop\Core\Security\Hashing` class to hash a password from a password and a salt with md5 [PR#31004](https://github.com/PrestaShop/PrestaShop/pull/31004)
...
* `Validate::isAnything()` → will be removed from 9.0 since returns always `true`
