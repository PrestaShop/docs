...
- When your module has forms, you should:
  ...
  - make sure information entered by customers are correct. If you ask a sum, it has to be only numbers. More information about the Validate class of PrestaShop [here](https://github.com/PrestaShop/PrestaShop/blob/9.0.x/classes/Validate.php).
