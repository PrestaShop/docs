...
In the `hookPaymentOptions()` method, you have to return an array of [`PaymentOption`](https://github.com/PrestaShop/PrestaShop/blob/9.1.x/src/Core/Payment/PaymentOption.php).
