---
Title: actionEmailBodyTemplateGridPresenterModifier
hidden: true
hookTitle: 'Modify email body template grid template data'
files:
    -
...
chain: false
origin: core
description: 'This hook allows to modify data which is about to be used in template for email body template grid'
