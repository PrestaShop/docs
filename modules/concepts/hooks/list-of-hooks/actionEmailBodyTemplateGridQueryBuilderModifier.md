---
Title: actionEmailBodyTemplateGridQueryBuilderModifier
hidden: true
hookTitle: 'Modify email body template grid query builder'
files:
    -
...
chain: false
origin: core
description: 'This hook allows to alter Doctrine query builder for email body template grid'
