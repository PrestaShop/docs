...
In order to generate a symfony route in javascript, you can use the [`Router` component](https://github.com/PrestaShop/PrestaShop/blob/9.1.x/admin-dev/themes/new-theme/js/components/router.ts).
