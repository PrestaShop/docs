...
PrestaShop provides its own test suite, running with Playwright. It covers the features of PrestaShop and grows each time a bug is resolved or a feature is added.
