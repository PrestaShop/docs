...
The `sendemail=1` parameter can be used on order_carriers endpoint to send the in transit email with the tracking number. Example : `http://example.com/api/order_carriers/12345?sendemail=1`
