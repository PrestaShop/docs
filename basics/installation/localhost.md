...
[Clone the repository using Git][installing-prestashop] or extract the zip package in a `prestashop` folder inside the document folder of the AMP installer you chose:
