...
You can download it from [Addons marketplace](https://addons.prestashop.com/en/data-migration-backup/5496-.html) or from your shop administration panel. It is also available on the module GitHub repository, in the [Releases](https://github.com/PrestaShop/autoupgrade/releases) section.