...
The `{l}` function allows you to insert translated text in your template using the [Translation system]({{< ref "/1.7/development/internationalization/translation/_index" >}}).
...
PrestaShop 1.7 introduced a new way to display modules in a theme, called [Widgets]({{< ref "/1.7/modules/concepts/widgets/_index" >}}). Instead of using a hook and hooking your module to it, the widget functions allow you explicitly manipulate your module from a template.
