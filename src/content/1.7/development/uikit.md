...
The UIKit is a project extending Bootstrap 4 in order to provide some components with PrestaShop's colors. You can see every component on [this page](http://build.prestashop.com/prestashop-ui-kit/).
