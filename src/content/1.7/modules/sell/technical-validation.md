...
The Validator (https://validator.prestashop.com) is a tool created to check your module is technically compatible with the PrestaShop requirements. You can:
...
{{% notice info %}}
**Important!**  
Since version 1.6.1.0, PrestaShop uses the PSR-2 norm. Even if we recommend you to use this norm, it's not mandatory and it won’t be a reason to decline your module. Here are more details in [this blog article](https://build.prestashop.com/news/prestashop-moves-to-psr-2/).
{{% /notice %}}
