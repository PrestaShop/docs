...
You can alter the Core files OR override them by copying them on `themes/<your-themes>/pdf` folder.
...
{{< figure src="../img/invoice_style.png" title="Stylized Invoice exemple" >}}
...
{{< figure src="../img/invoice_note.png" title="Invoice with extra content exemple" >}}