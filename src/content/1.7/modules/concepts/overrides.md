...
See [the hooks chapter]({{< ref "1.7/modules/concepts/hooks/_index" >}}) for more details.
...
See [the controllers chapter]({{< ref "1.7/modules/concepts/controllers/_index" >}}) for more details.
...
See [the Symfony services chapter]({{< ref "1.7/modules/concepts/services/_index" >}}) for more details.
