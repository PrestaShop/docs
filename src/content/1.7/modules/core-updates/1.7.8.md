...
`PrestaShop\PrestaShop\Core\Form\FormHandler` is deprecated in favor of `PrestaShop\PrestaShop\Core\Form\Handler`
`Windows` is deprecated
`PrestaShop\PrestaShop\Core\Domain\SpecificPrice\Command\AddSpecificPriceCommand` use `PrestaShop\PrestaShop\Core\Domain\SpecificPrice\UpdateProductPriceInCartCommand` or `PrestaShop\PrestaShop\Core\Domain\SpecificPrice\AddProductSpecificPriceCommand`
`PrestaShop\PrestaShop\Core\Email\SmtpDataConfigurator` is deprecated
`PrestaShop\PrestaShop\Core\Product\Search\URLFragmentSerializer` is deprecated 
`PrestaShopBundle\Controller\Admin\Configure\AdvancedParameters::searchAction` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Configure\AdvancedParameters\WebserviceController::searchAction` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Configure\ShopParameters\MetaController::searchAction` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Improve\Design\CmsPageController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Improve\International\CurrencyController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Improve\International\LanguageController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Improve\International\TaxController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Sell\Catalog\CategoryController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Sell\Customer\CustomerController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Controller\Admin\Sell\Order\CreditSlipController` use `PrestaShopBundle\Controller\Admin\CommonController:searchGridAction` instead
`PrestaShopBundle\Entity\Repository\LogRepository::getSearchQueryBuilder` use `PrestaShop\PrestaShop\Core\Grid\Query\LogQueryBuilder::getSearchQueryBuilder` instead
`PrestaShopBundle\Entity\Repository\LogRepository::getCountQueryBuilder` use `PrestaShop\PrestaShop\Core\Grid\Query\LogQueryBuilder::getCountQueryBuilder` instead
`PrestaShopBundle\Entity\Repository\LogRepository::buildGridQuery` use `PrestaShop\PrestaShop\Core\Grid\Query\LogQueryBuilder::buildGridQuery` instead
`PrestaShopBundle\Entity\Repository\RequestSqlRepository::getSearchQueryBuilder` use `PrestaShop\PrestaShop\Core\Grid\Query\RequestSqlQueryBuilder::getSearchQueryBuilder` instead
`PrestaShopBundle\Entity\Repository\RequestSqlRepository::buildQueryBySearchCriteria` use `PrestaShop\PrestaShop\Core\Grid\Query\RequestSqlQueryBuilder::buildQueryBySearchCriteria` instead
`PrestaShopBundle\Form\Admin\Configure\ShopParameters\OrderPreferences\OrderPreferencesFormDataProvider` is deprecated
`PrestaShopBundle\Form\Admin\Configure\ShopParameters\ProductPreferences\ProductPreferencesFormDataProvider` is deprecated
`PrestaShopBundle\Form\Admin\Configure\ShopParameters\TrafficSeo\Meta\MetaSettingsFormDataProvider` is deprecated
`PrestaShopBundle\Form\Admin\Improve\International\Geolocation\GeolocationFormDataProvider` is deprecated
`PrestaShopBundle\Form\Admin\Improve\Shipping\Preferences\PreferencesFormDataProvider` is deprecated
`PrestaShopBundle\Kernel\ModuleRepository` use `PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository` instead
`PrestaShopBundle\Kernel\ModuleRepositoryFactory` is deprecated

### Deprecated properties

`Combination::$location` is deprecated, use `StockAvailable::$location` instead
`Combination::$quantity` is deprecated, use `StockAvailable::$location` instead
`Product::$quantity` is deprecated, use `StockAvailable::$quantity` instead
`Product::$location` is deprecated, use `StockAvailable::$location` instead
`Product::$out_of_stock` is deprecated, use `StockAvailable::$out_of_stock` instead
`Product::$advanced_stock_management` is deprecated, this feature is not maintained anymore
`Product::$depends_on_stock` is deprecated, this feature is not maintained anymore
`StockAvailable::$depends_on_stock` is deprecated, this feature is not maintained anymore
