...
Another new feature for Tabs, when a module is enabled/disabled all its related [Tab links are automatically show/hidden]({{< ref "1.7/modules/concepts/controllers/admin-controllers/tabs#automatic-hiding-of-disabled-modules" >}}).
