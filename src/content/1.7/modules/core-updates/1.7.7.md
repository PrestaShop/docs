...
Instead, `/usr/sbin/sendmail` took the default way of sending mails.
{{% notice warning %}}
You should check that you environment is configured to allow this use or change this setting in **Configure** > **Advanced Parameters** > **E-mail** by another sending method like SMTP.
{{% /notice %}}
