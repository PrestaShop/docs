...
[See this schema](../img/form-schema.jpg) which sums up how Form Handlers, Form Builders, Controllers and Data Providers
are wired together.
...
### Hook dispatching in a modern Controller
...
### Hook dispatching using the Hook dispatcher
...
### Hook dispatching/rendering in Twig templates
...
You can build either assets either for environment DEV or PRODUCTION. In DEV environment, files are easier to read and debug. However when you submit the Pull Request, assets must be built for PRODUCTION.
