...
Follow instruction on **[Back-Office benchmark page](https://devdocs.prestashop-project.org/1.7/scale/benchmark/back-office/)** to get a pre-populated shop and to run Gatling scenarios on it.
